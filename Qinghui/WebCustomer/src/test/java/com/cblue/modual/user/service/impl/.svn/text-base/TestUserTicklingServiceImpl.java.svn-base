...
public class TestUserTicklingServiceImpl {
	private UserTicklingService userTicklingServiceImpl;
	@Before
	public void setUpBeforeClass(){
		ApplicationContext ac = new ClassPathXmlApplicationContext("classpath:beans.xml");
		userTicklingServiceImpl = (UserTicklingService)ac.getBean("userTicklingServiceImpl");
