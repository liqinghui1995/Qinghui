...
public class NourishmentSectionedAdapter extends SectionedBaseAdapter {
	
	private Context mContext;
	private String[] leftStr;
	private String[][] rightStr;
	
	public NourishmentSectionedAdapter(Context context, String[] leftStr, String[][] rightStr){
    ...
    public View getItemView(final int section, final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            layout = (LinearLayout) inflator.inflate(R.layout.nourishment_list_item, null);
        } else {
...
//        ((TextView) layout.findViewById(R.id.textItem)).setText(rightStr[section][position]);
    ...
    public View getSectionHeaderView(int section, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            LayoutInflater inflator = (LayoutInflater) parent.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            layout = (LinearLayout) inflator.inflate(R.layout.nourishment_header_item, null);
        } else {
            layout = (LinearLayout) convertView;
        }
