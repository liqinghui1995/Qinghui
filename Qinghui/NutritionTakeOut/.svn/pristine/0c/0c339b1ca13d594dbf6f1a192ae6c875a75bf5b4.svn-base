...
public class RegisenFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		view = inflater.inflate(R.layout.fragment_regimen, null);
		...
		shopCart = (ImageView) view.findViewById(R.id.Regisen_shopping_car_car);
	...
	private void test() {
		...
		headerListView = (PinnedHeaderListView) view.findViewById(R.id.pinnedListView2);
		listView=(ListView) view.findViewById(R.id.regiten_listview);
