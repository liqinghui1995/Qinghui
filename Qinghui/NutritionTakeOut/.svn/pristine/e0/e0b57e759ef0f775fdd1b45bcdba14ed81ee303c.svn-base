package com.example.nutrition.shark;
...
import com.example.nutrition.shark.ShakeListener.OnShakeListener;

public class MyShark  extends BaseActivity {
...
//		Toast.makeText(MyShark.this, "摇一摇", 1).show();
		//监听shark
		...
		mShakeListener = new ShakeListener(MyShark.this);
